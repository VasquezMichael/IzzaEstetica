      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 text-left max-w-2xl">
            <h3 className="text-4xl md:text-5xl text-neutral-950 mb-4 lg:text-5xl">
              100% Natural
            </h3>
            ...
            <div className="flex flex-col items-start gap-4">
              <div className="flex items-center gap-3 text-neutral-950">
                ...
                <span className="text-base">Sin quimicos agresivos</span>
              </div>
              <div className="flex items-center gap-3 text-neutral-950">
                <Flower2 className="w-5 h-5 flex-shrink-0" strokeWidth={1} />
                <span className="text-base">Bondad vegetal</span>
              </div>
              <div className="flex items-center gap-3 text-neutral-950">
                <Globe className="w-5 h-5 flex-shrink-0" strokeWidth={1} />
                <span className="text-base">Origen etico</span>
              </div>
            </div>
          </div>
        </div>
